...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@ew-color-picker/utils')) :
    typeof define === 'function' && define.amd ? define(['@ew-color-picker/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ewColorPicker = factory(global.util));
    ...
    class Box {
        ...
        constructor(options = {}) {
            ...
            this.options = util__default["default"].ewAssign({}, options);
            this.box = null;
            this.render();
        }
        getChildren() {
        ...
        render() {
            ...
            container?.appendChild(util__default["default"].createByTemplate(temp));
            this.box = util__default["default"].$(".ew-color-picker-box", container);
            this.setBoxSize();
        ...
        bindHandler() {
            if (this.box) {
                ...
                util__default["default"].on(this.box, "click", () => {
                    onClick?.(this);
                });
            }
        }
        normalizeSize(v) {
            if (util__default["default"].isNumber(v)) {
                return v;
            }
            return parseInt(`${v}`);
        }
        setBoxSize() {
            ...
            if (this.box) {
                if (width) {
                    util__default["default"].setStyle(this.box, { width: `${this.normalizeSize(width)}px` });
                }
                if (height) {
                    util__default["default"].setStyle(this.box, { height: `${this.normalizeSize(height)}px` });
                }
            }
        }
        setBoxBgColor(color) {
            if (this.box) {
                if (color) {
                    ...
                    util__default["default"].setStyle(this.box, { backgroundColor: color ?? defaultColor });
                }
            }
        }
    }
    ...
    const initConfig = (options) => {
        if (util__default["default"].isShallowObject(options)) {
            const { el, ...other } = options;
            return util__default["default"].ewAssign(defaultConfig, {
                el: util__default["default"].checkContainer(el),
                ...other,
            });
        }
        else {
            return util__default["default"].ewAssign(defaultConfig, {
                el: util__default["default"].checkContainer(options),
            });
        }
    };
    const normalizeBox = (config) => {
        ...
        if (util__default["default"].isString(size)) {
            switch (size) {
                case "normal":
        ...
        else if (util__default["default"].isDeepObject(size)) {
    ...
    class ewColorPicker {
        ...
        render() {
            ...
            el?.appendChild(util__default["default"].createByTemplate(CORE_TEMPLATE));
            this.container = util__default["default"].checkContainer(util__default["default"].$(".ew-color-picker", el));
            if (hasBox) {
